# AbsaUGDTMicroInternalUtilitySvc
...
To build the final jar and optimize the AbsaUGDTMicroInternalUtilitySvc application for production, run:
...
Then navigate to [http://localhost:9043](http://localhost:9043) in your browser.
